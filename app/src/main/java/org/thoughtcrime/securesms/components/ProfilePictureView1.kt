...
import network.qki.messenger.databinding.ViewProfilePicture1Binding
...
class ProfilePictureView1 @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : RelativeLayout(context, attrs) {
    private val binding: ViewProfilePicture1Binding by lazy { ViewProfilePicture1Binding.bind(this) }
