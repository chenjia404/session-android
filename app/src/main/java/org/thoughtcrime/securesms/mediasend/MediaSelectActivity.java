 ...
 */
public class MediaSelectActivity extends PassphraseRequiredActionBarActivity implements ETMediaPickerFolderFragment.Controller,
        MediaPickerItemFragment.Controller,
        ETMediaSendFragment.Controller,
    ...
    protected void onCreate(Bundle savedInstanceState, boolean ready) {
        ...
        if (isCamera) {
            ...
            ETMediaPickerFolderFragment fragment = ETMediaPickerFolderFragment.newInstance();
            getSupportFragmentManager().beginTransaction()
...
//        ETMediaSendFragment sendFragment = (ETMediaSendFragment) getSupportFragmentManager().findFragmentByTag(TAG_SEND);
//        if (sendFragment == null || !sendFragment.isVisible()) {
    ...
    public void onAddMediaClicked(@NonNull String bucketId) {
        ...
        ETMediaPickerFolderFragment folderFragment = ETMediaPickerFolderFragment.newInstance();
    ...
    @Override
    public void onSendClicked(@NonNull List<Media> media) {
    ...
    private void navigateToMediaSend() {
        ETMediaSendFragment fragment = ETMediaSendFragment.newInstance();
    ...
    private void navigateToCamera() {
        Permissions.with(this)
                ...
                .onAnyDenied(() -> Toast.makeText(MediaSelectActivity.this, R.string.ConversationActivity_signal_needs_camera_permissions_to_take_photos_or_video, Toast.LENGTH_LONG).show())
                .execute();
    }
